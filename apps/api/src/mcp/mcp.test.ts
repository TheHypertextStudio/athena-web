...
import type { registerTools as RegisterTools } from './tools';
import type { registerResources as RegisterResources } from './resources';
import type { mcpHandler as McpHandler } from './server';
...
beforeAll(async () => {
  ...
  registerTools = (await import('./tools')).registerTools;
  registerResources = (await import('./resources')).registerResources;
  mcpHandler = (await import('./server')).mcpHandler;
});
