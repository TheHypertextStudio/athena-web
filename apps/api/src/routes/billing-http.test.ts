...
import type { ActorCtx, AppEnv } from '../context';
import { onError } from '../error';
import type billingRouter from './billing';
import type cronRouter from './cron';
import type webhooksRouter from './webhooks';
...
beforeAll(async () => {
  ...
  webhooks = (await import('./webhooks')).default;
  cron = (await import('./cron')).default;
  billing = (await import('./billing')).default;
});
