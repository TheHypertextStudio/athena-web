...
import type cyclesRouter from './cycles';
import type initiativesRouter from './initiatives';
import type milestonesRouter from './milestones';
import type programsRouter from './programs';
...
beforeAll(async () => {
  schema = await getDb();
  db = schema.db;
  initiatives = (await import('./initiatives')).default;
  programs = (await import('./programs')).default;
  cycles = (await import('./cycles')).default;
  milestones = (await import('./milestones')).default;
});
