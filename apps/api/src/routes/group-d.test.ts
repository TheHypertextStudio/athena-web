...
import type agentSessionsRouter from './agent-sessions';
import type dailyPlanRouter from './daily-plan';
import type hubRouter from './hub';
import type notificationsRouter from './notifications';
import type orgsRouter from './orgs';
...
beforeAll(async () => {
  schema = await getDb();
  db = schema.db;
  orgs = (await import('./orgs')).default;
  notifications = (await import('./notifications')).default;
  dailyPlan = (await import('./daily-plan')).default;
  hub = (await import('./hub')).default;
  agentSessions = (await import('./agent-sessions')).default;
});
