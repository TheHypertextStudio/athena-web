...
function seedOrg(
  capabilities: Parameters<typeof seedMcpUpdateOrg>[2],
): ReturnType<typeof seedMcpUpdateOrg> {
  return seedMcpUpdateOrg(db, schema, capabilities);
}
...
async function seedTask(
  ...
  return seedMcpUpdateTask(db, schema, s, values);
}
