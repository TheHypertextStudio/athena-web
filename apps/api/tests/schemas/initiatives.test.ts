...
} from '../../src/schemas/initiatives.js';
...
describe('createInitiativeSchema', () => {
  ...
  it('should accept valid parent ID', () => {
    ...
    expect(result.parentId).toBe('00000000-0000-4000-8000-000000000001');
  });
...
describe('updateInitiativeSchema', () => {
  ...
  it('should validate all fields together', () => {
    ...
    expect(result.parentId).toBe('00000000-0000-4000-8000-000000000002');
  });
});
