...
description: "The 26 tools, the docket:// resource scheme, the bootstrap prompts, and the scopes each one needs."
---

**26 tools**, a set of `docket://` resources, and 3 prompts. Each is named for what the caller is
trying to do.
...
<AccordionGroup>
  ...
  <Accordion title="Agents, sessions, and connectors: 7 tools">
    | Tool | Does |
    | --- | --- |
