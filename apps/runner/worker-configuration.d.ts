/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: c035091fd1ef65063a4b3dc4ac136ebb)
// Runtime types generated with workerd@1.20260710.1 2026-07-16 nodejs_compat
interface __BaseEnv_Env {
	ATHENA_RUN_QUEUE: Queue;
	ATHENA_WORKFLOW: Workflow<Parameters<import("./src/index").AthenaExecutionWorkflow['run']>[0]['payload']>;
}
