 ...
 * passwordless passkey ceremonies (sign-up, sign-in, the deletion step-up re-auth) then complete
 * headlessly without real hardware. Origin, HTTPS-trust, headless, and trace/screenshot policy
 * come from `playwright.config.ts`, never per-spec.
 */
import { test as base, expect } from '@playwright/test';

import { addVirtualAuthenticator } from './webauthn.mjs';
