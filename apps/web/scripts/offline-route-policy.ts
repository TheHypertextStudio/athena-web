 ...
 * @returns The formatter-normalized source of `src/lib/offline-routes.generated.ts`.
 */
export async function renderRouteModule(routes: readonly ResolvedRoute[]): Promise<string> {
