 ...
 *
 * @remarks
 * The interactive roster (filter/sort/group + create). Rendered by the server `page.tsx`, which
 * SSR-prefetches the projects/tasks/members queries and wraps this in a `<HydrationBoundary>`, so
 * the `useApiListQuery` reads below hydrate from a warm cache on first paint (no skeleton).
 *
