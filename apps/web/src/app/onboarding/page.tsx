 ...
 *
 * - **Just me** → creates the personal workspace and proceeds directly to connections.
...
export default function OnboardingPage(): JSX.Element {
  ...
  // Personal setup has no intermediate sales screen: selecting it creates the workspace and
  // opens connection setup. Team setup still waits for the submitted organization name.
  useEffect(() => {
  ...
  return (
    <WizardShell
      ...
      footer={
        <>
          {error ? (
            <p role="alert" className="text-error text-body-medium mr-1">
              {error}
            </p>
          ) : null}
