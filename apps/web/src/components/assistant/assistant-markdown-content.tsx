...
const markdownComponents: Components = {
  ...
  pre: ({ children, ...props }) => (
    <pre
      className={cn('bg-surface-container-highest rounded-lg p-3', 'overflow-x-auto text-sm')}
      {...props}
    >
      {children}
    </pre>
  ...
  blockquote: ({ children, ...props }) => (
    <blockquote
      className={cn('border-outline my-2 border-l-2 pl-3', 'text-on-surface-variant italic')}
      {...props}
    >
      {children}
    </blockquote>
