 ...
 *
 * It is a `<Panel>`, not a popover: it docks to a corner of the canvas instead of covering the
 * node it describes, so the highlighted card and its edges stay visible while it is open.
 */
