...
export function CommandPaletteTrigger({ className }: CommandPaletteTriggerProps): JSX.Element {
  ...
  return (
    <button
      ...
      className={cn(
        'border-outline-variant text-on-surface-variant hover:bg-surface-container-high hover:text-on-surface focus-visible:ring-ring text-body-medium flex h-9 items-center gap-2 rounded-md border bg-transparent px-3 transition-colors focus-visible:ring-1 focus-visible:outline-none',
        className,
      )}
    >
