...
import { parsePersistedMarkdown } from './parse-markdown';
...
export function StaticMarkdown({ value, className }: StaticMarkdownProps): JSX.Element {
  const tokens = useMemo(() => parsePersistedMarkdown(value), [value]);
  return (
