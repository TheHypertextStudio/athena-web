 ...
 * personal space; the team / nonprofit fork walks through naming a shared workspace. These types
 ...
 * the shared `connect` beat; the team / nonprofit fork shows `name`, then `connect`. A final
