/**
 * Relative-time formatting for the Programs screens.
 *
 * @remarks
 * Update timestamps and the "created" stamp read better as a human "2h ago" stamp than a
 ...
 * "8 days ago" is less useful than the date itself). Mirrors the project-detail helper so
 * the two screens read identically without coupling their folders.
 */
