      ...
      {tabs.map((tab, index) => {
        ...
        return (
          <button
            ...
            className={cn(
              'focus-visible:ring-ring text-body-medium relative -mb-px flex min-h-10 items-center gap-2 rounded-t-md px-3 py-2 font-medium transition-colors outline-none focus-visible:ring-1',
              selected
                ? 'text-on-surface'
