    ...
    >
      <DialogContent showClose={false}>
        ...
        <DialogFooter>
          ...
          <button
            type="button"
            className="focus-visible:ring-ring bg-error text-on-error hover:bg-error/90 text-body-medium rounded-md px-3 py-1.5 font-medium shadow-sm transition-colors outline-none focus-visible:ring-1"
            onClick={onConfirm}
          >
            Disconnect
          </button>
