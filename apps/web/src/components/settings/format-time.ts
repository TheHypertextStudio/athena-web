/**
 * Relative-time formatting for the settings surfaces (e.g. an integration's "last synced" stamp).
 *
 * @remarks
 * A human "2h ago" reads better than a raw ISO date. Uses the platform
 * `Intl.RelativeTimeFormat` for locale-aware phrasing, falling back to an absolute date for
