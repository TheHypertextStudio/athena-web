...
export function IntegrationActionButton({
  ...
  return (
    <button
      type={type}
      className={cn(
        'focus-visible:ring-ring text-label-large inline-flex items-center justify-center gap-1.5 rounded-md px-3 py-1.5 transition-colors outline-none focus-visible:ring-1 disabled:opacity-50',
        TONE[tone],
        className,
      )}
      {...props}
