  ...
  return (
    <li className="hover:bg-surface-container-high flex min-h-14 items-center gap-3 px-3 py-2 transition-colors">
      ...
      <div className="flex min-w-0 flex-1 items-center gap-2">
        <span className="text-on-surface text-label-large truncate">{displayName}</span>
        {isSelf ? <span className="text-on-surface-variant text-body-small">You</span> : null}
        {isGuest ? <Badge variant="secondary">Guest</Badge> : null}
      </div>
