        ...
        <header className="mb-1.5 min-w-0">
          {href ? (
            <a
              href={href}
              className={cn(
                'text-on-surface text-title-small hover:text-primary block w-fit max-w-full rounded-sm outline-none',
                focusRing,
              )}
            >
        ...
        {relatedCount > 0 ? (
          <div className="mt-1">
            <button
              ...
              className={cn(
                'text-on-surface-variant text-label-medium hover:text-on-surface min-h-10 rounded-md px-2 outline-none',
                focusRing,
              )}
            >
              {expanded
