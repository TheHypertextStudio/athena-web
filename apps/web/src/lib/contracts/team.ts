/**
 * `domain packages` — Team slice DTOs.
 *
 * @remarks
...
import { ApprovalRouting } from '@docket/athena/agent-contract';
...
export const TeamOut = z
  .object({
    ...
    actorId: ActorId.optional().describe(
      "The team's assignable actor id. Present on current API reads; optional for backward-compatible cached payloads.",
    ),
