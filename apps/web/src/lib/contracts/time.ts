/**
 * `domain packages` — Time Ledger DTOs.
 *
 * @remarks
...
import { EntityRef } from '@docket/connections/event-contract';
import { AgentExecutionId, AgentSessionId } from '@docket/athena/ids';
