...
// The dialog moved into `@docket/ui`. Mocking the whole module would drop every other component
// this test renders, so the real module is spread and one export replaced.
