...
- As a user, I receive guidance on how to proceed if I try to sign into my account using an identity provider that is not recognized or has been disconnected
...
- As a user, I can pause and resume a running timer so that I can take breaks without losing my progress
- As a user, I can stop a timer and have the tracked time automatically associated with the current task
- As a user, I can modify the duration and notes of a time tracking session after it has been recorded
- As a user, I can add time entries retroactively for work I completed but forgot to track
- As a user, I can designate multiple blocks of time that I work on a task so that I can track discontinuous work sessions
- As a user, I can delete time tracking entries that were created in error
...
- As a user, I receive autocomplete hints for actions that are context-dependent and adapt to data that is relevant to the current view or selected item
...
- As a user, I am able to use Athena to help me create initiatives
- As a user, I can view a live draft of an initiative during initiative creation sessions
- As a user, I am able to create initiatives completely on my own without any assistance from Athena if I want
...
- As a user, I can allow others to view workspaces I have created by sharing a link or inviting them directly
...
- As a user, I can chat with Athena using natural language to ask questions about my tasks, projects, and schedule
- As a user, I can ask Athena to create tasks, events, or projects on my behalf
- As a user, I can ask Athena to summarize my progress on an initiative or project
- As a user, I can ask Athena to suggest how to prioritize my work for the day
- As a user, I can ask Athena to estimate how long a task will take based on similar past work
- As a user, I can ask Athena to identify conflicts or overcommitments in my schedule
- As a user, I can ask Athena to generate action items from documents, emails, or notes I provide
- As a user, I can configure which LLM provider Athena uses (Anthropic, OpenAI, or self-hosted)
- As a user, I can review and approve actions Athena proposes before they are executed
- As a user, I can see the conversation history with Athena and reference previous interactions

# Notifications

- As a user, I can receive email notifications for upcoming deadlines and scheduled events
- As a user, I can receive push notifications on my devices for reminders and updates
- As a user, I can configure which types of events trigger notifications
- As a user, I can set quiet hours during which notifications are suppressed
- As a user, I can receive Slack notifications if I have linked my Slack workspace
- As a user, I can receive SMS notifications for critical reminders if I have provided my phone number
- As a user, I can snooze notifications to be reminded later

# Real-time Sync

- As a user, I can see changes made on one device reflected immediately on other devices
- As a user, I can work offline and have my changes sync when I reconnect
- As a user, I am notified if there are sync conflicts that require my attention
- As a user, I can resolve sync conflicts by choosing which version to keep

# Attachments

- As a user, I can attach files to tasks, projects, and initiatives
- As a user, I can attach links with automatic preview generation
- As a user, I can view attached files inline without leaving the app
- As a user, I can see all attachments associated with an entity in a dedicated section
- As a user, I can remove attachments from entities I own

# Activity Streams

- As a user, I can create activity streams to track different types of activities
- As a user, I can log activities manually with a type, start time, and end time
- As a user, I can connect integrations to automatically populate activity streams
- As a user, I can see my activities visualized on a timeline alongside my calendar
- As a user, I can filter and search through my activity history
- As a user, I can export my activity data for analysis in external tools

# Subscriptions and Billing

- As a user, I can view my current subscription plan and its features
- As a user, I can upgrade or downgrade my subscription plan
- As a user, I can view my billing history and download invoices
- As a user, I can update my payment method
- As a user, I can cancel my subscription and understand what data will be retained

# Integrations (Extended)

- As a user, I can link my Spotify account to track my listening activity
- As a user, I can link my Fitbit, Apple Health, or other fitness tracker to see health data alongside my work
- As a user, I can link my Toggl or RescueTime account to import time tracking data
- As a user, I can link my Todoist account to sync tasks bi-directionally
- As a user, I can link my Notion workspace to see pages and databases referenced in tasks
- As a user, I can disconnect any linked integration and choose whether to retain or delete its data
- As a user, I can see when integrations last synced and manually trigger a sync
