...
| 3. Spatial rhythm & density       | 4     | The shell reserves 80px. Rail targets are 64×60, indicators are 56×32, and auxiliary and recent icon targets are 40×40. The workspace mark is 32×32 inside its 40×40 target. |
...
| 8. Detail craft                   | 3     | The focus ring follows the indicator pill instead of outlining the full rectangular hit box. The larger workspace mark and recent icons align on the rail centerline.        |
