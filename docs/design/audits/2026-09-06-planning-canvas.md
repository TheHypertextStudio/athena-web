...
| The board on a 1440px window           | The canvas is the surface; chrome gives way to it                 | With the labelled sidebar, the Athena rail, and the docked inspector open, the board was a 560px strip (39%) | The route asks the shell for its icon rail while a plan is open (any window under 1920px); the board takes 741px (51%) beside the inspector and 1020px (71%) without it |
