...
| ------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------- | -------------- | -------------------------------------------------------------------------- |
| **Calendar events** (recurring, all-day, RSVP/participants) — _foundation for the rest_                                  | None                                        | Heavy          | `routes/events.ts`, `routes/events/serializers.ts`                         |
...
| **Agenda** (unified daily view: tasks + events + blocks + utilization) — _depends on events, time-blocks, time-tracking_ | Partial (`daily-plan.ts`, narrower)         | Heavy          | `routes/agenda.ts`, `components/agenda/`                                   |
...
| **Analytics** (productivity metrics) — _depends on time-tracking_                                                        | None                                        | Moderate       | `routes/analytics.ts` + `services/analytics/`                              |
