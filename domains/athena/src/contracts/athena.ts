/**
 * `domain packages` — personal Athena connection, assignment, and trigger contracts.
 *
 * @remarks
...
export const AthenaTriggerOut = z
  .object({
    id: AthenaTriggerId,
    assignmentId: AthenaAssignmentId,
