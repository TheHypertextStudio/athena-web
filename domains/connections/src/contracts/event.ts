/**
 * `domain packages` — the canonical cross-tool Event contract.
 *
 * @remarks
...
import { EventId, InboundEventId, IntegrationId } from '../ids';

const DailyDigestId = z.string().regex(/^[0-9A-HJKMNP-TV-Z]{26}$/);
