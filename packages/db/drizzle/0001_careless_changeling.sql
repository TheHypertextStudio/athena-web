...
CREATE TABLE "oauth_application" (
	...
	"created_at" timestamp DEFAULT now() NOT NULL,
	"updated_at" timestamp DEFAULT now() NOT NULL,
	CONSTRAINT "oauth_application_client_id_uq" UNIQUE("client_id")
);
--> statement-breakpoint
...
CREATE UNIQUE INDEX "oauth_access_token_access_token_uq" ON "oauth_access_token" USING btree ("access_token");--> statement-breakpoint
CREATE UNIQUE INDEX "oauth_access_token_refresh_token_uq" ON "oauth_access_token" USING btree ("refresh_token");--> statement-breakpoint
