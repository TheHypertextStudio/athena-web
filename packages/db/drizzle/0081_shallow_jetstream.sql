...
UPDATE "organization_product_entitlement" AS "entitlement"
SET "source" = 'complimentary', "status" = 'active', "updated_at" = now()
FROM "billing_exemption" AS "exemption"
WHERE "exemption"."organization_id" = "entitlement"."organization_id"
