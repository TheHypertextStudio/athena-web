...
ALTER TABLE "agent_delegation" ADD CONSTRAINT "agent_delegation_returned_activity_id_session_activity_id_fk" FOREIGN KEY ("returned_activity_id") REFERENCES "public"."session_activity"("id") ON DELETE set null ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "agent_delegation" ADD CONSTRAINT "agent_delegation_assignment_owner_fk" FOREIGN KEY ("assignment_id","owner_user_id") REFERENCES "public"."athena_assignment"("id","owner_user_id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "agent_delegation" ADD CONSTRAINT "agent_delegation_session_owner_fk" FOREIGN KEY ("session_id","owner_user_id") REFERENCES "public"."agent_session"("id","owner_user_id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
