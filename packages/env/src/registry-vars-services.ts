...
export const SERVICE_VARS: readonly VarSpec[] = [
  ...
  {
    name: 'ATHENA_LATTICE_SUBMISSIONS_ENABLED',
    slice: 'agent',
    scope: 'server',
    targets: ['api'],
    required: true,
    zod: agentServer.ATHENA_LATTICE_SUBMISSIONS_ENABLED,
    where: 'true|false — stop or allow new durable Athena submissions to personal Lattice runtimes',
  },
  {
    name: 'ATHENA_LATTICE_POLLING_ENABLED',
    slice: 'agent',
    scope: 'server',
    targets: ['api'],
    required: true,
    zod: agentServer.ATHENA_LATTICE_POLLING_ENABLED,
    where: 'true|false — stop or allow polling and settlement of existing Lattice work',
  },
  {
