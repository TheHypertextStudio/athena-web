...
export const SERVICE_VARS: readonly VarSpec[] = [
  ...
  },
  {
    ...
    targets: ['api'],
    required: false,
    zod: agentServer.GOOGLE_CLOUD_PROJECT,
    where: 'Google Cloud project used by the Vertex Athena backend',
  },
  {
    ...
    targets: ['api'],
    required: false,
    zod: agentServer.GOOGLE_CLOUD_LOCATION,
    where: 'Vertex location for Athena model turns',
  },
  {
    name: 'ATHENA_MODEL',
    slice: 'agent',
    ...
    targets: ['api'],
    required: false,
    zod: agentServer.ATHENA_MODEL,
    where: 'Optional model override for the selected Athena backend',
  },
  {
  ...
  },
  {
    ...
    targets: ['api'],
    required: true,
    zod: voiceServer.PHONE_VERIFICATION_ENABLED,
    where: 'true|false — public phone-verification gate; keep false during the owner canary',
  },
  {
    name: 'PHONE_VERIFICATION_CANARY_EMAILS',
    slice: 'voice',
    scope: 'server',
    targets: ['api'],
    required: false,
    zod: voiceServer.PHONE_VERIFICATION_CANARY_EMAILS,
    where: 'CSV of verified Better Auth account emails admitted before public verification opens',
  },
  {
  ...
  {
    name: 'TWILIO_VERIFY_API_KEY_SID',
    slice: 'voice',
    scope: 'server',
    targets: ['api'],
    required: false,
    zod: voiceServer.TWILIO_VERIFY_API_KEY_SID,
    where: 'Scoped Twilio API key SID used only for phone verification',
  },
  {
    name: 'TWILIO_VERIFY_API_KEY_SECRET',
    slice: 'voice',
    scope: 'server',
    targets: ['api'],
    required: false,
    zod: voiceServer.TWILIO_VERIFY_API_KEY_SECRET,
    where: 'Secret paired with the scoped Twilio Verify API key',
    sensitive: true,
  },
] as const;
