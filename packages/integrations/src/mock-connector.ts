/**
 * `@docket/integrations` — `MockConnector`.
 *
 * @remarks
...
export class MockConnector implements Connector {
   ...
   * {@link import('./linear').LinearProviderClient.pullWorkGraph}'s filter
   * semantics exactly.
   *
   * @remarks
   ...
   * {@link import('./linear').LinearProviderClient.listTeamStates}'s ordering —
