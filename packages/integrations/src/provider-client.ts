...
export interface ResolvedAccount {
   ...
   * {@link import('./connector').ConnectionResult.externalWorkspaceId}.
   */
 ...
 * {@link import('./connector').Connector.asMailActor}. Membership must agree with
 ...
 * {@link import('./connector').Connector.asWorkGraph}.
 */
