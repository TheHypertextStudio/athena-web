/**
 * `@docket/integrations` - `RealConnector` + the concrete provider clients.
 *
 * @remarks
 ...
 * real-shaped by the API container and never in `APP_MODE ∈ {local,test}`. The
 ...
 * This is only the provider I/O edge. Every request-building and
