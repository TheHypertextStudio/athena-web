...
export function SidebarNavItem({
  ...
  // reads at `text-body-large`, and the inline glyph stays at `size-4` so it sits optically
  // balanced beside the label. The 40px control step supplies the minimum target used by the
