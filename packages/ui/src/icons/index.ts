...
export { default as CloudSync } from '@mui/icons-material/CloudSyncOutlined';
...
export { default as PhonePasskey } from '@mui/icons-material/PhonelinkLockOutlined';
...
export { default as Usb } from '@mui/icons-material/UsbOutlined';
