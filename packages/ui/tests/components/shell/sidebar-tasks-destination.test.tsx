 ...
 *
 * 1. the row's **presence and company**: Tasks is a direct row of a shared workspace's nav, in the
 *    same flat list as Projects and Initiatives, with no disclosure or sub-group between them;
 ...
 *
 * The Home group keeps its own Tasks row: the two rows are two altitudes over one noun ("what is on
 * my plate anywhere" vs "what work exists in this workspace"), exactly as Stream is. A personal
 * workspace has only the one altitude, so it shows Tasks and Stream once, in Home.
 */
...
describe.each([{ presentation: 'a shared org workspace', personalWorkspace: false }])(
  'Tasks in the Workspace nav of $presentation',
  ({ personalWorkspace }) => {
