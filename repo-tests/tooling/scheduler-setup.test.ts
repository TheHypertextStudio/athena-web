 ...
 *    views of the same twenty-four paths, so this file carries the list as the deliberate third
...
describe('scheduler-setup — the twenty-four jobs', () => {
  ...
  it('pins the exact twenty-four paths on both sides', () => {
