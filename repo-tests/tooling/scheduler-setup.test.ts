 ...
 *    views of the same twenty-five paths, so this file carries the list as the deliberate third
...
describe('scheduler-setup — the twenty-five jobs', () => {
  ...
  it('pins the exact twenty-five paths on both sides', () => {
