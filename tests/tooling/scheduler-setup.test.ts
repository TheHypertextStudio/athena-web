 ...
 *    views of the same twenty paths, so this file carries the list as the deliberate third
...
describe('scheduler-setup — the twenty jobs', () => {
  ...
  it('pins the exact twenty paths on both sides', () => {
