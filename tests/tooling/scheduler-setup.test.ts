 ...
 *    views of the same nineteen paths, so this file carries the list as the deliberate third
...
describe('scheduler-setup — the nineteen jobs', () => {
  ...
  it('pins the exact nineteen paths on both sides', () => {
