 ...
 *    views of the same fifteen paths, so this file carries the list as the deliberate third
...
describe('scheduler-setup — the fifteen jobs', () => {
  ...
  it('pins the exact fifteen paths on both sides', () => {
